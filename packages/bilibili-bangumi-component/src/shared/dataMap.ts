import type { AnimeCollection, BookCollection, CollectionLabel, CollectionType, GameCollection, RealCollection, Subject, SubjectType } from './types'
...
export const realCollectionMap: Record<RealCollection, CollectionType> = {
  全部: '0',
  想看: '1',
  在看: '2',
  看过: '3',
